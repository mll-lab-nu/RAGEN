...
for config_str in "${CONFIGS[@]}"; do
    ...
    for type_str in "${TYPES[@]}"; do
        ...
        for inc_str in "${INC_ZEROS[@]}"; do
            ...
            EXP_NAME="soko_3b_ppo_${stra_suffix}_${type_suffix}_${inc_suffix}"
...
echo "All PPO experiments completed."
