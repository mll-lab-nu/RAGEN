...
morestate_overrides=(
  "es_manager.render_multi_actions=True"
)

init_singleton "$(basename "${BASH_SOURCE[0]}")"

launch sokoban "sokoban_coord_3b_base_ppo_think_s_morestate_apt2" True ppo s 8 800 "${morestate_overrides[@]}" agent_proxy.max_actions_per_turn=2
wait_sleep_reset_check

launch sokoban "sokoban_coord_3b_base_ppo_think_s_no_morestate_apt2" True ppo s 8 800 agent_proxy.max_actions_per_turn=2
wait_sleep_reset_check

launch sokoban "sokoban_coord_3b_base_ppo_think_s_morestate_apt4" True ppo s 8 800 "${morestate_overrides[@]}" agent_proxy.max_actions_per_turn=4
wait_sleep_reset_check

launch sokoban "sokoban_coord_3b_base_ppo_think_s_no_morestate_apt4" True ppo s 8 800 agent_proxy.max_actions_per_turn=4
wait_sleep_reset_check

launch sokoban "sokoban_coord_3b_base_ppo_think_s_morestate_apt3" True ppo s 8 800 "${morestate_overrides[@]}" agent_proxy.max_actions_per_turn=3
wait_sleep_reset_check

launch sokoban "sokoban_coord_3b_base_ppo_think_s_no_morestate_apt3" True ppo s 8 800 agent_proxy.max_actions_per_turn=3
wait_sleep_reset_check

launch sokoban "sokoban_coord_3b_base_ppo_think_s_morestate_apt5" True ppo s 8 800 "${morestate_overrides[@]}" agent_proxy.max_actions_per_turn=5
wait_sleep_reset_check

launch sokoban "sokoban_coord_3b_base_ppo_think_s_no_morestate_apt5" True ppo s 8 800 agent_proxy.max_actions_per_turn=5
wait_sleep_reset_check